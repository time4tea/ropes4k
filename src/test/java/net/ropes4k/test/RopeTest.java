...
public class RopeTest {
    ...
    public void testConcatenationFlatFlat() {
        ...
        assertEquals("alphabeta", r3.toString());

        r1 = Rope.BUILDER.build("The quick brown fox jumped over");
        r3 = r1.append(r1);
        assertEquals("The quick brown fox jumped overThe quick brown fox jumped over", r3.toString());
    }
    ...
    public void testIterator() {
        ...
        for (int j = 0; j < c2.length(); ++j) {
            assertTrue(i.hasNext(), "Has next (" + j + "/" + c2.length() + ")");
            i.next();
        }
    ...
    public void testCreation() {
        try {
            ...
            fail("Nonempty string: " + e.getMessage());
        }
        try {
            Rope.BUILDER.build("");
        } catch (final Exception e) {
            fail("Empty string: " + e.getMessage());
        }
    }
    ...
    public void testIndexOf() {
        ...
        assertEquals(1, r3.indexOf('l'));
        assertEquals(6, r3.indexOf('e'));
    ...
    public void testInsert() {
        final Rope r1 = Rope.BUILDER.build("alpha");
        assertEquals("betaalpha", r1.insert(0, "beta").toString());
        assertEquals("alphabeta", r1.insert(r1.length(), "beta").toString());
        assertEquals("abetalpha", r1.insert(1, "beta").toString());
    }
    ...
    public void testPrepend() {
        ...
        assertEquals("alphaalphaalphabeta", r1.toString());
        r1 = r1.append(r1.subSequence(5, 15));
        assertEquals("alphaalphaalphabetaalphaalpha", r1.toString());
    }
    ...
    public void testRegexp() {
        ...
        for (int i : indices) {
            assertEquals(r.charAt(i), c.charAt(i), "Index: " + i);
        }
    }
    ...
    public void testIndexOfBug() {
        {   // original test, bwatkins
            ...
            assertEquals(s1.indexOf(s2), r1.indexOf(s2));
        }
        {   // extra test, aahmad
